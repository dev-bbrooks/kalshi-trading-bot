...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .glass { background: rgba(13, 17, 23, 0.5); -webkit-backdrop-filter: blur(20px) saturate(1.5); backdrop-filter: blur(20px) saturate(1.5); }
  ...
  .fs-panel { position:fixed;left:0;right:0;bottom:0;background:var(--card);
    ...
    height:85vh;z-index:151;will-change:transform;transform:translateY(110%);overflow:hidden;
...
<div id="devPanels">
  <div id="devPanels-wrap">
      <div id="term-claude-panel" class="term-panel">
        <div id="term-claude-header" class="panel-header">
          <div class="panel-header-left">
            <select class="header-model-select" id="term-claude-hdr-model"><option value="sonnet" selected>Sonnet</option><option value="opus">Opus</option></select>
          </div>
          <div class="panel-header-center">
            <span class="claude-dot cdot-none" id="term-claude-hdr-dot"></span>
            <span class="tch-title">Claude Code</span>
          </div>
          <div class="panel-header-right">
            <button class="header-btn--icon-only" id="term-claude-new-btn" title="New Session"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
          </div>
        </div>
        <div id="term-conversation"></div>
        <div id="term-input-area" class="panel-footer">
          <textarea class="header-textbox" id="term-prompt-input" rows="1" placeholder="Claude Code"></textarea>
          <div class="footer-row">
            <button class="header-btn--icon-only" id="term-claude-paste-btn" title="Paste"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 4h2a2 2 0 012 2v14a2 2 0 01-2 2H6a2 2 0 01-2-2V6a2 2 0 012-2h2"/><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/><path d="M12 11v6"/><path d="M9 14l3 3 3-3"/></svg></button>
            <div style="flex:1"></div>
            <button id="term-enhance-send-btn" title="Enhance &amp; Send"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="7 15 12 10 17 15"/><polyline points="7 9 12 4 17 9"/></svg></button>
      ...
      <div id="term-shell-panel" class="term-panel">
        ...
        <div id="term-shell-input-area">
          ...
          <textarea id="term-shell-input" rows="1" placeholder="Shell"></textarea>
